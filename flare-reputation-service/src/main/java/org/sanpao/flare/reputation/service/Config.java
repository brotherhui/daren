...
@Configuration
@ComponentScan
@PropertySource({ "classpath:reputation-service-config.properties" })
public class Config {
	...
	@Bean
	public Ignite reputationServiceIgnite() {
		...
		configuration.setIgniteInstanceName("FLARE_REPUTATION_SERVICE_NODE");
