...
@Configuration
@ComponentScan
@PropertySource({ "classpath:advertisement-service-config.properties" })
public class Config {
	...
	@Bean
	public Ignite advertisementServiceIgnite() {
		...
		configuration.setIgniteInstanceName("FLARE_ADVERTISEMENT_SERVICE_NODE");
