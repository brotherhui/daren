...
@Configuration
@ComponentScan
@PropertySource({ "classpath:payment-service-config.properties" })
public class Config {
	...
	@Bean
	public Ignite paymentServiceIgnite() {
		...
		configuration.setIgniteInstanceName("FLARE_PAYMENT_SERVICE_NODE");
